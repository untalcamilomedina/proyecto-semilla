...
Revision ID: 6fe3e393b59c
Revises: 
Create Date: 2025-09-07 13:55:04.558817
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name='collaboration_rooms_pkey'),
    postgresql_ignore_search_path=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_collaborative_sessions_id'), table_name='collaborative_sessions')
    op.drop_table('collaborative_sessions')
    op.drop_index(op.f('ix_user_cursors_id'), table_name='user_cursors')
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_collaboration_rooms_id'), table_name='collaboration_rooms')
    op.drop_index(op.f('ix_collaboration_rooms_tenant_id'), table_name='collaboration_rooms')
