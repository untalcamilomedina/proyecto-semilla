...
class TestEmailService:
    ...
    def test_send_invite_email(self):
        inviter = User.objects.create_user(
            email="inviter@example.com", username="inviter", password="password"
        )
        invitee = User.objects.create_user(
            email="invitee@example.com", username="invitee", password="password"
        )
        ...
        membership = Membership.objects.create(
            user=invitee, organization=tenant, role=role, is_active=False
        )
