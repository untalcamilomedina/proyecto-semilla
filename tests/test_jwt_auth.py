...
class TestTenantTokenObtainPairSerializer:
    ...
    def test_get_token_adds_email_claim(self):
        ...
        with (
            ...
            patch("core.models.Membership.objects") as mock_qs,
        ):
...
class TestJWTSettings:
    ...
    def test_jwt_custom_serializer(self):
        ...
        assert (
            settings.SIMPLE_JWT["TOKEN_OBTAIN_SERIALIZER"]
...
class TestDRFAuthConfig:
    ...
    def test_jwt_auth_is_primary(self):
        """Verify JWT (con binding de tenant) is the first auth class."""
        from django.conf import settings

        auth_classes = settings.REST_FRAMEWORK["DEFAULT_AUTHENTICATION_CLASSES"]
        assert auth_classes[0] == "api.authentication.TenantJWTAuthentication"
